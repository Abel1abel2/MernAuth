...
const getSecond=(timer)=>{
  ...
  return (
    <>
    <div className='w-[90%] sm:w-184  min-h-50 ml-4 sm:ml-100 h-50 mt-5    bg-blue-800  absolute '>
    <form onSubmit={handleSubmit} className=' mt-10 text-center flex flex-col justify-between space-y-4 max-h-150 py-5 sm:py-10 w-[100%] sm:max-w-600 bg-gray-100'>
      ...
      <div onPaste={(e)=>handlePaste(e)} className='sm:px-35 px-10 h-30 mt-8 flex justify-between sm:w-200 w-[100%] sm:space-x-5 space-x-1'>
       {
       ...
       <button type='submit' className='bg-black text-white text-lg rounded w-60 h-12 sm:h-25 sm:w-120  sm:ml-33 ml-13  cursor-pointer'>Verify</button>
    </form>
